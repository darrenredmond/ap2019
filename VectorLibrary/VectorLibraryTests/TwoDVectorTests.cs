...
namespace VectorLibraryTests
{
    ...
    public class TwoDVectorTests
    {
         ...
         */
        [TestMethod]
        public void Adding3By3VectorTo6By2VectorGives9By5Vector()
        {
            TwoDVector vec3x3 = new TwoDVector(3F, 3F);
            TwoDVector vec6x2 = new TwoDVector(6F, 2F);
            TwoDVector vec9x5 = vec3x3 + vec6x2;
            Assert.AreEqual(9, vec9x5.I);
            Assert.AreEqual(5, vec9x5.J);
        }

        [TestMethod]
        public void Subtract3By3VectorFrom4By4VectorGives1By1Vector()
        {
            TwoDVector vec3x3 = new TwoDVector(3F, 3F);
            TwoDVector vec4x4 = new TwoDVector(4F, 4F);
            TwoDVector vec1x1 = vec4x4 - vec3x3;
            Assert.AreEqual(1, vec1x1.I);
            Assert.AreEqual(1, vec1x1.J);
        }
    }
}
